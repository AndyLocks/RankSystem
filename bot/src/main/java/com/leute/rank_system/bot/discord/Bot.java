package com.leute.rank_system.bot.discord;
...
public class Bot {
    ...
    private final Collection<EventListener> listenerAdapters;

    public Bot(String token, Collection<EventListener> listenerAdapters) {
        this.token = token;
