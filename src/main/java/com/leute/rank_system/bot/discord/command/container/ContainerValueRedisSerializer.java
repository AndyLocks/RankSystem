 ...
 */
public class ContainerValueRedisSerializer implements RedisSerializer<AbstractContainer> {

    private Logger LOG = LoggerFactory.getLogger(ContainerValueRedisSerializer.class);
