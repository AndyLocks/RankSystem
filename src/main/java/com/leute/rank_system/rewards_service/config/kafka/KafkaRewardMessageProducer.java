...
@Configuration
@EnableKafka
public class KafkaRewardMessageProducer {

    @Value("${kafka.host}")
    private String kafkaHost;

    @Bean
    public ProducerFactory<String, RewardMessage> rewardProducerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, RewardMessage> rewardKafkaTemplate() {
